...
public class MedicalStuff extends User { 
    /**
     *
     */
    private static final long serialVersionUID = 1L;

    public MedicalStuff(String name, String username, String password, String usertype, String contact, String address) { 
    ...
    public void saveLog(String s) {
        try {
            ...
            File file = new File("src/files/users/medicalstuff/" + username + "_log.bin"); 
            if (!file.exists()) {
                file.createNewFile();
            }
