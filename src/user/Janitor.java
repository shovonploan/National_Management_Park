...
public class Janitor extends User { 
    ...
    public Janitor(String name, String username, String password, String usertype, String contact, String address) { 
    ...
    public void saveLog(String s) {
        try {
            ...
            File file = new File("src/files/users/janitor/" + username + "_log.bin"); 
            if (!file.exists()) {
                file.createNewFile();
            }
