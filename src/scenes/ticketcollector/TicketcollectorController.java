package scenes.ticketcollector;
...
public class TicketcollectorController implements Initializable {
    ...
    public void initial(){
        String mystring="";
        try {
            File file= new File("src/files/users/ticketcollector/"+filename+"_job.txt"); 
    ...
    public void setUser(TicketCollector u){
        t1=u;
