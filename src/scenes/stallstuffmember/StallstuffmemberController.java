package scenes.stallstuffmember;
...
public class StallstuffmemberController implements Initializable {
    ...
    public void initial(){
        String mystring="";
        try {
            File file= new File("src/files/users/stallstuffmember/"+filename+"_job.txt");
    ...
    public void setUser(Stallstuffmember u)
    {
        s1=u;
