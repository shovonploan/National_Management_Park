package scenes.landscapeprofessional;
...
public class LandscapeprofessionalController implements Initializable {
    ...
    private LandscapeProfessional l1;
    ...
    public void initial(){
        String mystring="";
        try {
            File file= new File("src/files/users/landscapeProfessional/"+filename+"_job.txt");
    ...
    public void setUser(LandscapeProfessional u)
    {
        l1=u;
